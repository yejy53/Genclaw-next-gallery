...
最后值得一提的是，我们在 [GenClaw](https://github.com/yejy53/GenClaw) 讨论中强调：未来一部分多模态内容创作的最终产物，可能并不局限于最后的像素图输出。基于 Visual Code 生成的可编辑视觉产物，在文字准确、分层编辑控制等方面也非常具有潜力，有利于用户进一步完成内容创作与生产。下面的结果，也进一步展示了视觉内容生成，相比于单纯图像像素生成的显著优势。
