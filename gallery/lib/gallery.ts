...
export const copy = {
  zh: {
    ...
    researchBody:
      "长文形式的方法说明、评测记录与实现笔记。正文限制在 760px，图表放宽到 1040px，脚注区再放宽到 1280px。",
    noPosts: "还没有公开的文章。",
    outline: "文章目录",
    pendingAsset: "素材待补",
    pendingLink: "链接待补",
  ...
  en: {
    ...
    researchBody:
      "Long-form method write-ups, evaluation records, and implementation notes. Body text holds at 760px, media widens to 1040px, and the footnote zone widens again to 1280px.",
